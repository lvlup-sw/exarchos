 ...
 *
 * At runtime `tools/release/build-binary.ts` is executed by Bun (`bun run
 * tools/release/build-binary.ts`), so the import resolves to Bun's built-in module.
 ...
 * site in `tools/release/build-binary.ts`. Widen this declaration when a call site
