...
#
# Usage:
#   tools/release/smoketest-rc2.sh                       # auto-detect runtime
#   tools/release/smoketest-rc2.sh --runtime claude      # force runtime
#   tools/release/smoketest-rc2.sh --skip-functional     # surface checks only
#   tools/release/smoketest-rc2.sh --version 2.9.0-rc.2  # override expected version
#
