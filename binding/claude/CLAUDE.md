...
`mcp__plugin_exarchos_exarchos__exarchos_*` MCP tools, or the `/exarchos:` workflow
commands where the harness supports them. The Exarchos event store is the
