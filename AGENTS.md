...
- **exarchos_event** — Append-only JSONL event store with 46 event types (includes `shepherd.started`, `shepherd.iteration`, `shepherd.approval_requested`, `shepherd.completed`)
