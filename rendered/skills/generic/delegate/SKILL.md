...
1. Read the failure output from the runtime's result-collection primitive (`[task output is the assistant's next message]`) and the settlement finding's message
