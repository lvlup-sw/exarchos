...
1. Read the failure output from the runtime's result-collection primitive (`inline reply from task --agent (no separate collection API)`) and the settlement finding's message
