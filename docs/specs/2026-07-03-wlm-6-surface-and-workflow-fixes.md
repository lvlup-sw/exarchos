...
**Files:** `orchestrate/prepare-review.ts` (`:176-210`), `views/workflow-state-projection.ts`, `workflow/state-machine.ts` (`:872-881`, edge-scoped), `orchestrate/prepare-review.test.ts`, `views/workflow-state-projection.test.ts`
...
**Files:** `orchestrate/prepare-review.ts`, `orchestrate/prepare-review.test.ts`, `workflow/state-machine.test.ts` (delegate-unchanged + overhaul-edge-still-fires assertions)
