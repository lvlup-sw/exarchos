...
**Files:** `.exarchos/invariants.md` (INV-11), `servers/exarchos-mcp/src/index.ts`, `servers/exarchos-mcp/src/dispatch/core/context.ts`, `servers/exarchos-mcp/src/capabilities/`
