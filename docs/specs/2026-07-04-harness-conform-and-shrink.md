...
**Files:** `servers/exarchos-mcp/src/orchestrate/onboard/hooks.ts`, `servers/exarchos-mcp/src/orchestrate/doctor/checks/` (new check), `servers/exarchos-mcp/src/dispatch/core/onboarding/reconcile.ts`, `servers/exarchos-mcp/src/orchestrate/onboard/onboard.parity.test.ts`
