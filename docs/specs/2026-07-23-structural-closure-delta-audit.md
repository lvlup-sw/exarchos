...
> `docs/audits/structural-closure-delta-audit/unified-remediation-plan.md`.
> The decomposition below describes production of the audit package, not a
> second code-remediation sequence.
