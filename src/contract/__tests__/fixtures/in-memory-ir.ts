...
import { makeDeclaration, type AnyDeclaration, type DeclarationKind } from '../../declaration.js';
 ...
 * against this module's actual exported signatures.
 */
export const STORE_AFTER_RELOCATION = `
import type { DeclarationSource } from '../../declaration-seam.js';
import { openInMemoryIr, IR_NODES } from './in-memory-ir.js';
