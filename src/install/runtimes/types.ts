 ...
 * `src/runtime/agents/capabilities.ts`). Duplicated here to
 ...
 * by per-runtime YAML tests (e.g. `src/runtime/runtimes/
 ...
 * `src/runtime/agents/adapters/types.ts` — see that file for
