...
vi.mock('./gates/test-adequacy.js', async (importActual) => {
  const actual = await importActual<typeof import('./gates/test-adequacy.js')>();
  return {
    ...actual,
    runProbe: async () => ({
...
vi.mock('./gates/contract-drift.js', async (importActual) => {
  const actual = await importActual<typeof import('./gates/contract-drift.js')>();
  return {
    ...actual,
...
vi.mock('./gates/mock-boundary.js', async (importActual) => {
  const actual = await importActual<typeof import('./gates/mock-boundary.js')>();
  return {
    ...actual,
...
vi.mock('./gates/gate-severity.js', () => ({
