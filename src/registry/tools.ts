...
export const TOOL_REGISTRY: readonly BuiltinCompositeTool[] = [
  ...
  },
  {
    ...
    cli: { alias: 'orch' },
    slimDescription: 'Task coordination, gates, validation, VCS. describe(actions) for schemas.\n\nActions: task_claim, task_complete, task_fail, review_triage, prepare_delegation, prepare_synthesis, assess_stack, check_static_analysis, check_integration_suite, check_security_scan, check_diff_hygiene, check_review_verdict, check_provenance_chain, check_plan_coverage, check_post_merge, check_task_decomposition, check_event_emissions, extract_task, review_diff, verify_worktree, select_debug_track, investigation_timer, assess_refactor_scope, check_pr_comments, validate_pr_body, validate_pr_stack, extract_fix_tasks, generate_traceability, spec_coverage_check, verify_worktree_baseline, setup_worktree, verify_delegation_saga, post_delegation_check, reconcile_state, runbook, agent_spec, onboard, doctor, create_pr, merge_pr, check_ci, list_prs, get_pr_comments, add_pr_comment, create_issue, merge_orchestrate, check_invariant_conformance, acquire_worktree, release_worktree, prune_worktrees, reconcile_worktrees, serialize_merge, stack_place',
  },
  {
    name: 'exarchos_view',
    ...
    actions: viewActions,
    cli: { alias: 'vw' },
    slimDescription: 'CQRS materialized views for pipeline, tasks, and telemetry. Use describe(actions) for schemas.\n\nActions: pipeline, tasks, workflow_status, stack_status, telemetry, team_performance, delegation_timeline, code_quality, eval_results, quality_correlation, quality_attribution, quality_hints, delegation_readiness, synthesis_readiness, shepherd_status, session_provenance, provenance, invariants_effective, worktrees, ps, wait',
  },
  {
    name: 'exarchos_sync',
