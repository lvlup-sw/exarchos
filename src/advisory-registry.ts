 ...
 *     `servers/exarchos-mcp/src/evals/run-evals-cli.ts`. NEWLY DISCOVERED
...
export const ADVISORY_REGISTRY: readonly AdvisoryEntry[] = [
  ...
  },
  {
    ...
    ciFilterRationale:
      ...
      'skills/**, commands/**, rules/**, evals/**, a handful of servers/exarchos-mcp/src ' +
...
export function probeEvalCapabilityLayer(
  ...
  const cli = join(opts.repoRoot, 'servers', 'exarchos-mcp', 'src', 'evals', 'run-evals-cli.ts');
