...
description: "Transform design documents into TDD-based implementation plans with granular, parallelizable tasks. Activates when user runs /plan or wants to break down a design into tasks."
---
...
2. Output: "Plan saved with [N] tasks. Continuing to delegation..."
3. The delegation skill will auto-activate based on phase
