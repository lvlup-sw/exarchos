...
Use this template when dispatching tasks via the agent system.
...
if ((Get-Location).Path -notmatch "\.worktrees") {
    Write-Host "ERROR: Not in worktree!" -ForegroundColor Red
    exit 1
}
```
...
## Working Directory
C:\Users\dev\project\.worktrees\task-003
