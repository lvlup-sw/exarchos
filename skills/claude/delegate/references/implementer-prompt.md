...
The table below shows which sections to include per dispatch mode. Unmarked sections (Verification, Files, Success Criteria, Completion) are **always included** in both modes.
