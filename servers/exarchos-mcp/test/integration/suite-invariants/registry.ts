...
export const ACCEPTED_GAPS: readonly AcceptedGap[] = Object.freeze([
  ...
  },
  {
    ...
    kind: 'shape-annotation-debt',
    files: [
      'servers/exarchos-mcp/src/contract/oracle/oracle-seam.test.ts',
  ...
  // ── The new tiers, which are NOT exemplary yet ──────────────────────────
  {
    ...
    kind: 'shape-annotation-debt',
    files: ['servers/exarchos-mcp/test/integration/public-root/actions.test.ts'],
    suppresses: ['oracle-sources-missing'],
    owner: 'T-36 owner',
    expires: '2026-10-31',
  ...
  },
  {
    ...
    files: ['servers/exarchos-mcp/test/integration/governance/merge-idempotency.test.ts'],
  ...
  },
  {
    ...
    kind: 'known-defect',
    files: ['servers/exarchos-mcp/test/integration/governance/denied-transition.test.ts'],
    suppresses: [],
    owner: 'workflow-platform',
    expires: '2026-11-30',
