...
// ════════════════════════════════════════════════════════════════════════════
// DR-26 — the SDK generation seam (task 053)
// ════════════════════════════════════════════════════════════════════════════

// Fixture specifiers are ASSEMBLED, never written literally — the same
// convention `sdk/seam.test.ts` and `architecture/sdk-generation-seam.test.ts`
// use. Under a parse-based instrument a specifier inside a template literal is
// already not an import, so this is no longer load-bearing for correctness; it
// is retained because it makes THIS file contribute zero to the DR-26 bypass
// population under every instrument that has ever measured it, so the live-tree
// assertions below cannot go red for a reason internal to the test.
