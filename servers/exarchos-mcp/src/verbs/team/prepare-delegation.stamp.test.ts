...
import { parseTaskStamps } from '../tasks/parse-task-stamps.js';
...
describe('#1636 registered schema retains per-task stamps', () => {
  it('RegisteredSchema_TaskWithStamps_FieldsSurviveParse', () => {
      ...
      tasks: [
        {
          ...
          files: ['servers/exarchos-mcp/src/verbs/worktree/manager.ts'],
          blockedBy: ['002'],
    ...
    expect(t.files).toEqual(['servers/exarchos-mcp/src/verbs/worktree/manager.ts']);
