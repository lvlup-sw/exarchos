...
vi.mock('./gates/test-adequacy.js', async (importOriginal) => {
  const actual = await importOriginal<typeof import('./gates/test-adequacy.js')>();
...
vi.mock('./gates/contract-drift.js', async (importOriginal) => {
  const actual = await importOriginal<typeof import('./gates/contract-drift.js')>();
...
vi.mock('./gates/mock-boundary.js', async (importOriginal) => {
  const actual = await importOriginal<typeof import('./gates/mock-boundary.js')>();
...
import { gateRunnerObservationSource } from './gates/gate-runner.js';
