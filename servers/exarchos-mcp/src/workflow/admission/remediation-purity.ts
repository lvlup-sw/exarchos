...
// scan of a module's own import surface yielding a typed verdict, so a
// regression (a new import that reaches the event store, the filesystem, a
// process, the network, or a phase/transition mutation) trips it rather than a
// hand-maintained mirror. The lexical half of that scan is a caller-supplied
// port (DR-2) — see the note above {@link ImportLexer}.
//
