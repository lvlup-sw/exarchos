...
import { handleCleanup, collectCleanupEvidence } from './cleanup.js';
...
import {
  ...
  type SourceModule,
} from './retirement/retirement-safety.js';
...
describe('DR-8 — retirement-safety registry reflects the retirement', () => {
  ...
  it('RetirementSafety_RetiredAndLegacyRegistries_DoNotOverlap', async () => {
    ...
    const { LEGACY_AUTHORITIES } = await import('./retirement/retirement-safety.js');
