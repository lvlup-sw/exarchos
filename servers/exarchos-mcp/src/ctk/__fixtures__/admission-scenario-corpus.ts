...
} from '../../workflow/admission/policy-authority.js';
import {
  buildRequirementContext,
  type RequirementContextInput,
} from '../../workflow/admission/requirement-context.js';
...
} from '../../workflow/admission/edge-condition.js';
import type { EdgeConditionFacts } from '../../workflow/admission/edge-condition-evaluate.js';
import type { EdgeCandidate } from '../../workflow/admission/edge-condition-select.js';
