...
import {
  ...
  isQuotedMention,
  sentenceBefore,
} from '../test-helpers/comment-prose.js';
...
describe('DR-26 — INV-7 is a closed claim (T-26 / EFF-001), not a target', () => {
  ...
  it('GoverningCatalog_Inv7_ReferencesTheMultiProcessFixtureThatClosedIt', () => {
    const fixture = 'servers/exarchos-mcp/test/process/multi-process-append.test.ts';
 ...
 * retired framing (`servers/exarchos-mcp/src/**\/*.ts`, excluding tests). The
