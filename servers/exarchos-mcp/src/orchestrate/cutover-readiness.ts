...
// DR-4 (task 083) — the two verbs' response contracts, paid down from
// `vacuityWaiver` to real `data` schemas. Held in their own module so the
// registry can import them without this file's closure (event store, dispatch
// context, admission provenance parsers) coming along.
