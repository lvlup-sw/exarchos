...
vi.mock('./test-adequacy.js', async (importActual) => {
  const actual = await importActual<typeof import('./test-adequacy.js')>();
  return {
    ...actual,
    runProbe: async () => ({
...
vi.mock('./contract-drift.js', async (importActual) => {
  const actual = await importActual<typeof import('./contract-drift.js')>();
  return {
    ...actual,
...
vi.mock('./mock-boundary.js', async (importActual) => {
  const actual = await importActual<typeof import('./mock-boundary.js')>();
  return {
    ...actual,
