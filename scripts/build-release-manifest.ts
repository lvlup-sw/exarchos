 ...
 * JavaScript statement that `scripts/build-binary.ts` passes to
...
/** The identity stamped into the compiled binary by `scripts/build-binary.ts`. */
...
// module (from `scripts/build-binary.ts` or a test) never shells out to git.
