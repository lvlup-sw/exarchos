...
//
// DR-20 / T-28. The installers (`scripts/get-exarchos.sh`, `get-exarchos.ps1`)
...
//     (produced by `scripts/build-release-manifest.ts:buildIdentityBanner`),
...
//
// It lives under `scripts/test-fixtures/` deliberately: root `package.json`
// `files[]` carries `"!**/test-fixtures"`, so none of this ships to consumers.
//
// It is also directly invokable (`tsx scripts/test-fixtures/release-fixture.ts
