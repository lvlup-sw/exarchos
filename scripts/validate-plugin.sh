...
#
# This file is a WRAPPER. The gate itself is scripts/validate-plugin.mjs, and
...
# because this path is the artifact name in scripts/guard-inventory.ts's Wave-1
