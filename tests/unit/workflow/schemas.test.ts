...
describe('TestingStrategySchema', () => {
  it('TestingStrategySchema_ValidMinimal_Parses', async () => {
    const { TestingStrategySchema } = await import('../../../src/workflow/schemas.js');
...
describe('Oneshot workflow type and schema', () => {
  ...
  it('workflowTypeSchema_acceptsOneshot', async () => {
    const { WorkflowTypeSchema } = await import('../../../src/workflow/schemas.js');
  ...
  it('workflowTypeSchema_getValidWorkflowTypesIncludesOneshot', async () => {
    const { getValidWorkflowTypes } = await import('../../../src/workflow/schemas.js');
...
describe('FeatureWorkflowStateSchema mergeOrchestrator field', () => {
  ...
  it('FeatureWorkflowState_RoundTripsWithMergeOrchestratorField_Equal', async () => {
    const { FeatureWorkflowStateSchema } = await import('../../../src/workflow/schemas.js');
    const input = {
      ...baseFeatureFixture,
      mergeOrchestrator: {
...
describe('RESERVED_FIELDS_DESCRIPTOR (#1360)', () => {
  ...
  it('ReservedFieldsDescriptorSchema_AcceptsCanonicalShape', async () => {
    const { ReservedFieldsDescriptorSchema, RESERVED_FIELDS_DESCRIPTOR } = await import('../../../src/workflow/schemas.js');
