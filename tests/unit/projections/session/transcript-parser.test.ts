...
import type { SessionToolEvent, SessionTurnEvent, SessionMetadata } from '../../../../src/projections/session/types.js';
...
describe('Transcript Parser — Turn Extraction', () => {
  it('extractTurns_AssistantEntry_ReturnsTokenBreakdown', async () => {
    const { extractTurns } = await import('../../../../src/projections/session/transcript-parser.js');
    const lines: unknown[] = [
      {
        sessionId: 'sess-1',
        type: 'assistant',
