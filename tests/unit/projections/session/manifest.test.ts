...
describe('Manifest Writer', () => {
  ...
  it('writeManifestEntry_ValidEntry_AppendsToManifestFile', async () => {
    const { writeManifestEntry } = await import('../../../../src/projections/session/manifest.js');
  ...
  it('readManifestEntries_ReturnsAllEntries', async () => {
    const { writeManifestEntry, readManifestEntries } = await import('../../../../src/projections/session/manifest.js');
    const entries = [
  ...
  it('findUnextractedSessions_ReturnsSessionsWithoutEventsFile', async () => {
    const { writeManifestEntry, findUnextractedSessions } = await import('../../../../src/projections/session/manifest.js');
