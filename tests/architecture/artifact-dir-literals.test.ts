...
const PROSE_BUDGET: Readonly<Record<string, number>> = {
  ...
  'servers/exarchos-mcp/src/orchestrate/design-completeness.ts': 1,
  'servers/exarchos-mcp/src/orchestrate/discover-bridge.ts': 1,
  'servers/exarchos-mcp/src/orchestrate/prepare-review.ts': 1,
